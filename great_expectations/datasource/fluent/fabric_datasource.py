...
class FabricDatasource(SQLServerDatasource):
    ...
    Args:
        ...
        encrypt: The TLS encryption protocol to use.
            ...
            Connection will fail if your Microsoft Fabric instance
            does not support TLS.
            - "Strict" - Require the connection to be encrypted and
            validate the server certificate. Connection will fail if
            your Microsoft Fabric instance does not support TLS
            or the certificate is not valid.
