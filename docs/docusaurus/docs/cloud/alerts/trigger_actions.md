...
If you want to send notifications to email addresses, Slack, Microsoft Teams, or PagerDuty, consider using [zero-code alerts](/cloud/alerts/alert_about_failures) instead of coding Actions. While Actions can be scaled programmatically, alerts give you more control over which severities of failures trigger which notifications. Alerts also give you the ability to @mention collaborators in Slack. 
:::
