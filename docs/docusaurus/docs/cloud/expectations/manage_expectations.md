...
- The Data Asset's Data Source must be AlloyDB, Amazon Aurora, Microsoft Fabric, Microsoft SQL Server, PostgreSQL, Citus, Databricks SQL, Neon, PostgreSQL, Redshift, or Snowflake.
